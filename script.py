...
antiga = pd.read_csv("Planilha Antiga\SLR_PRINCIPAL - ACM.csv")
atual = pd.read_csv("Planilhas Atuais\current_SLR - ACM.csv")
...
atual.to_csv("Resultado/current_SLR - ACM Modificado.csv", index=False)
